export const externalHelpSlides = [
    {
        text: "Stimulate them awake by yelling their name and administering a hard sternum rub to the chest plate.\n" +
        ...
        image: require("../assets/external_help_info/step1.png"),
    },
    {
        text: "Call for Help!\n" +
        ...
        image: require("../assets/external_help_info/step2.png"),
    },
    {
        text: "Administer Naloxone\n" +
            "Do rescue breathing for a few quick breaths if the person is not breathing.\n" +
            "Affix the nasal atomizer (applicator) to the needleless syringe and then assemble the glass cartridge of naloxone.\n" +
        ...
        image: require("../assets/external_help_info/step3.png"),
    },
    {
        text: "Perform Rescue Breathing or Chest Compressions\n" +
        ...
        image: require("../assets/external_help_info/step4.png"),
    },
]